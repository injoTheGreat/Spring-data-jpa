...
public class RegistrationController {
    ...
    public Registration create(@RequestBody @Valid Registration registration) {
        ...
        return this.registrationRepository.save(new Registration(
                null, registration.getProductId(), ticket, registration.getAttendeeName()));
    }
    ...
    public Registration update(@RequestBody Registration registration) {
        ...
        return this.registrationRepository.save(new Registration(existingRegistry.getId(), existingRegistry.getProductId(),
                ticketCode, registration.getAttendeeName()));
    }
